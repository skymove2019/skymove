...
<footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; E-chin 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="<?php echo base_url();?>admin/login">ใช่</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <script src="<?php echo base_url();?>adminassets/js/demo/chart-area-demo.js"></script>
    <script src="<?php echo base_url();?>adminassets/js/demo/chart-pie-demo.js"></script>
